/****** Object:  StoredProcedure [dbo].[Proc_GetRpt003]    Script Date: 30/10/2024 18:46:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_GetRpt003]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_GetRpt003]
GO
CREATE PROCEDURE [dbo].[Proc_GetRpt003]
AS
BEGIN
	SELECT CHR.Id,
